...
# files for upload to lab file server. 

# 1. Download and transfer Agilent files from /home/steve/Downloads
#    to /home/steve/Downloads/pi/agilent
# 2. Run core2agilentserv.pl, select # next to task needed
...
#    - after task#3: annotation and formatted record will be created; if missing, check code
#    - after task$4: zip file updated with annotation and formatted text; if missing, check code
# 4. If Steps #1-4 are completed without issues, move new zip file + _ann.csv to /fileserver/data/agilent data/pi/two color/
# 5. Update records by copying & pasting _ann.csv contents into /fileserver/data/agilent data/pi/two color/summary/two color_all.txt
##########################################################################
use strict;
use warnings;
#use Archive::Zip;
