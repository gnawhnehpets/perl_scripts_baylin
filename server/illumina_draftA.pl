...
###########################################################################
#WORKING CODE
#Extension of illumina_draft9.pl
#Added in file prefix for file names
#Plan of action: Add in Archive::Zip to compress files of same excel sheet
#                Parse for directory matching unique barcode
#                Add feature where excel broken up by PI
###########################################################################
use strict;
use warnings;
use Archive::Zip;
...
#							$write_xl->write($p_row,$h_col,$out_val);
						    }
...
###############################3
###############################
#							print FULLANN $wh_val."\t";
							print TABANN $wh_val."\t";
=d							
							print IND "\n>>>>>>>>>>>>>>>>>\n";
							print IND "> ROW: $p_row\tCOL: $h_col\n";
							print IND $h_val.": ".$wh_val."\t";
=cut
...
#		print IND "unique bar code\n";
	    ...
	    my $xl_row_num = 0;
	    my $write_xl_path = "$exp_dir/x/".$file_prefix."_annotation.xls";
	    ...
	    my $full_row_num = 0;
	    my $write_full_ann_path = "$exp_dir/x/".$file_prefix."_full_annotation.xls";
	    #my $write_xl_path = $exp_dir."x/TEST_tab_ann.xls";
