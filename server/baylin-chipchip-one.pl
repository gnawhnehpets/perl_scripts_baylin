...
#agilent backup/array worksheet/XXX 
my $datatype = "chip-chip";
#agilent backup/array data file/XXX
...
my $master_output = $txt_dir."summary/master_output.csv";
...
=cut
	...
	my $ann_txt = $ann_dir.$file_prefix."_ann.csv";
