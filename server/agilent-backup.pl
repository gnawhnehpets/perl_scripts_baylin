...
#file containing all related files (annotat
###########################################################################
use strict;
use warnings;
use Archive::Zip;
...
my $datatype = "CHANGE THIS";
#agilent backup/array data file/
my $data_dir = "/home/steve/Desktop/MA_core_download/backup/agilent backup/array data file/CHANGE THIS/";
###########################
=d
#Files to run script
