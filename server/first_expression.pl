...
my $exp_dir = "/home/steve/Desktop/MA_core_download/backup/illumina backup/DataOutput/Illumina sheet/work sheet/expression/test-exp/";
...
my $m27_dir = "/home/steve/Desktop/MA_core_download/backup/illumina backup/DataOutput/Illumina sheet/work sheet/baylin/test-exp/";
...
#    print $first."\n";
    my $path = $txtdir."individual/".$first."-TEST.txt";
    open(PATH, '>>', $path) || die "cannot open ind text file\n";
    print PATH $line."\n";
    close PATH;
}
